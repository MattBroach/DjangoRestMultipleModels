...
with open(os.path.join(base_dir, 'drf_multiple_model', '__init__.py')) as f:
    init_py = f.read()
...
copyright = get_init_prop('copyright', init_py)
author = get_init_prop('author', init_py)
...
version = get_init_prop('version', init_py)
# The full version, including alpha/beta/rc tags.
release = get_init_prop('version', init_py)
